...
class BN_KOTH_RscEscMenuKeybindings
{
    ...
    movingEnable = 0;
    enableSimulation = 1;
    onLoad = "_this call bn_koth_fnc_escMenu_keybindings_onLoad; [(_this select 0) displayCtrl 9101] call bn_koth_fnc_announcements_configureControl;";
