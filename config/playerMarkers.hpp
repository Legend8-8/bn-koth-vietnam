class CfgBnKothMapIcons
{
    ...
    markerType = "mil_triangle_noShadow";
    markerTexture = "\A3\ui_f\data\map\markers\military\triangle_CA.paa";
    markerColor[] = {1, 1, 1, 1}; //ColorWhite
    groupMarkerColor[] = {0, .8, 0, 1}; //ColorGreen

    // Overall visibility for local markers.
    markerAlpha = 1;
