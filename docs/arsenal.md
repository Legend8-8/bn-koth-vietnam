...
`ownedWeapons`, canonical `weaponKills`, and perk ownership/activation. It
deliberately excludes saved kits, the preferred kit ID, current
...
`profileNamespace`. The submitted array remains untrusted and must pass the normal server-owned
