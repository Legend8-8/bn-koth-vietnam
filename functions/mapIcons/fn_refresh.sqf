...
if !(missionNamespace getVariable ["BN_KOTH_mapIconsEnabled", true]) exitWith {
...
private _iconTexture = missionNamespace getVariable ["BN_KOTH_mapIconsTexture", "\A3\ui_f\data\map\markers\military\triangle_CA.paa"];
private _iconColor = missionNamespace getVariable ["BN_KOTH_mapIconsColorArray", [1, 1, 1, 1]];
private _groupIconColor = missionNamespace getVariable ["BN_KOTH_mapIconsGroupColorArray", [0, 1, 0, 1]];
private _showPassengerCount = missionNamespace getVariable ["BN_KOTH_mapIconsShowPassengerCount", true];
private _showDriverName = missionNamespace getVariable ["BN_KOTH_mapIconsShowDriverName", true];
...
uiNamespace setVariable ["BN_KOTH_mapIconsDrawData", _drawData];
