/*
    ...
    Author: Legend
    Description: Sends one complete weapon-slot composition intent through
        the authoritative loadout request path.
    Execution: Client
    Parameters:
        0: Weapon slot: PRIMARY or HANDGUN <STRING>
...
if !(_weaponSlot in ["primary", "handgun"]) exitWith {false};
