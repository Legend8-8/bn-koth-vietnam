...
switch (_exitCode) do {
    case 1: {
        ...
        {
            [_x, _pending getOrDefault [_x, 0], true] call bn_koth_fnc_escMenu_options_setValue;
        } forEach ["earplugVolumeGround", "earplugVolumeVehicle", "player3DIconsEnabled", "centerMapOnOpen", "player3DIconsAlpha"];
