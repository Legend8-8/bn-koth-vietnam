/*
    ...
    Author: tylervip
    Description: Stores a client-reported voice state for local map presentation.
...
missionNamespace setVariable ["BN_KOTH_playerMapIconsVoiceStates", _voiceStates];
true